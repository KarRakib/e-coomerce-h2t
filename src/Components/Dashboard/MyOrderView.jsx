                            ...
                            <div className="card rounded-md">
                                ...
                                <div className="card-body p-4">
                                            ...
                                            modified.map(order => (
                                                ...
                                                <div className="card-body">
                                                    <div className="grid grid-cols-5 gap-2">
                                                        ...
                                                        <div className="col-span-1 flex justify-center items-center">
                                                            <p className="text-gray-400 text-sm mb-0">{order.price * order.quantity} Tk </p>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="flex justify-between pt-2">
                                        ...
                                        <p className="text-gray-400 mb-0">
                                            <span className="font-bold me-4">Total</span> {totalPrice} Tk
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex justify-between mb-5">
                                        ...
                                        <p className="text-gray-400 mb-0">
                                            <span className="font-bold me-4">Delivery Charges</span> 150 Tk
                                        </p>
                                    </div>
                                </div>
                                <div className="card-footer border-0 px-4 py-5 bg-purple-500 rounded-b-md">
                                    <h5 className="flex items-center justify-end text-white uppercase mb-0">
                                        Total paid: <span className="text-2xl font-semibold ms-2">{0+150}Tk </span>
                                    </h5>
                                </div>
                            </div>
                        </div>
